<template>
    <div>
       <div class="header-nav" separator-class="el-icon-arrow-right">
           <span class="left">工会</span>
           <div class="right">
               <span>当前位置：</span>
               <el-breadcrumb separator-class="el-icon-arrow-right">
                    <el-breadcrumb-item :to="{ path: '/home' }">首页</el-breadcrumb-item>
                    <el-breadcrumb-item :to="{ path: '/parygroup/union' }">党群建设</el-breadcrumb-item>
                    <el-breadcrumb-item :to="{ path: '/parygroup/union' }">工会</el-breadcrumb-item>
                </el-breadcrumb>
           </div>
       </div>
